//
//  3DCarouselSliderViewController.swift
//  myspace
//
//  Created by admin on 2021/10/10.
//

import UIKit
import SwiftUI
@available(iOS 15.0, *)
class _DCarouselSliderViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        let swiftUIView = SliderContentView() // swiftUIView is View
